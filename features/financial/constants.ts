export const FINANCIAL_LIST_COLUMNS = `
  ...
  description, reference_number, supplier_id, supplier, client, amount, currency, entry_date, due_date,
  paid_at, paid_amount,
  source_module, source_id, is_system_generated,
  installment_number, installment_total, status, created_at,
...
export const FINANCIAL_DETAIL_COLUMNS = `
  ...
  description, reference_number, supplier_id, supplier, client, amount, currency, entry_date, due_date,
  paid_at, paid_amount,
  reversed_entry_id, source_module, source_id, is_system_generated,
