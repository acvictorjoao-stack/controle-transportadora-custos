export const FINANCIAL_LIST_COLUMNS = `
  ...
  description, reference_number, amount, currency, entry_date, due_date, paid_at,
  source_module, is_system_generated, status, created_at,
  ...
  financial_cost_centers:cost_center_id (id, name, center_type)
`;
...
export const FINANCIAL_DETAIL_COLUMNS = `
  ...
  category_id, cost_center_id, entry_type, entry_status,
  description, reference_number, amount, currency, entry_date, due_date, paid_at,
  reversed_entry_id, source_module, is_system_generated, notes,
