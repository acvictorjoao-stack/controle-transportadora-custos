export const FUEL_LIST_COLUMNS = `
  ...
  supplier_id, station_name, station_brand, city, state, fueled_at, fuel_type,
  ...
  payment_type, payment_due_date, installment_count, installment_interval_days, status, created_at,
...
export const FUEL_DETAIL_COLUMNS = `
  ...
  km_traveled, consumption_l_per_100km, km_per_liter, cost_per_km, autonomy_km,
  notes, responsible, is_inconsistent, inconsistency_flags,
  payment_type, payment_due_date, installment_count, installment_interval_days,
