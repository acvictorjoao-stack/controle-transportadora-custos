...
import type {MemberCredentials} from '@/features/organization/members/actions';

export interface MemberCredentialsSuccessProps {
  credentials: MemberCredentials;
  title?: string;
  onFinish: () => void;
}

function MemberCredentialsSuccess({
  credentials,
  title = 'Usuário criado com sucesso',
  onFinish,
}: MemberCredentialsSuccessProps) {
...
export {MemberCredentialsSuccess};
